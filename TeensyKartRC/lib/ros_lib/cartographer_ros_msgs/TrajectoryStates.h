...
namespace cartographer_ros_msgs
{
  ...
  class TrajectoryStates : public ros::Msg
  {
    ...
    TrajectoryStates():
      header(),
      trajectory_id_length(0), trajectory_id(NULL),
      trajectory_state_length(0), trajectory_state(NULL)
    {
    }
    ...
    const char * getType(){ return "cartographer_ros_msgs/TrajectoryStates"; };
    const char * getMD5(){ return "85efdd795e95b57a59cb785ecb152345"; };
