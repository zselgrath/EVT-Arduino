#ifndef _ROS_cartographer_ros_msgs_MetricLabel_h
#define _ROS_cartographer_ros_msgs_MetricLabel_h
...
namespace cartographer_ros_msgs
{
  ...
  class MetricLabel : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "cartographer_ros_msgs/MetricLabel"; };
